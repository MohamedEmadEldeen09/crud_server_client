...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping(value = "/users")   //->   http://localhost:8073/users/
public class UserController {
	...
	@GetMapping(value = "getallusers") //->   http://localhost:8073/users/getallusers
	public List<Users> getAllUsers(){
		return userRepo.findAll();
	}
	
	@GetMapping(value = "getuser/{id}")  //->   http://localhost:8073/users/getuser/2
	public Users getUser(@PathVariable Long id){
		return userRepo.findById(id).get();
	}
	
	
	@PostMapping(value = "adduser") //->   http://localhost:8073/users/adduser
	public String addUser(@RequestBody Users user){
		userRepo.save(user);
		return "user has saved successfully!";
	}
	
	@PutMapping(value = "updateuser/{id}") //->   http://localhost:8073/users/updateuser/1
	...
	@DeleteMapping(value = "deleteuser/{id}") //->   http://localhost:8073/users/deleteuser/2
